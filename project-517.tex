...
\author{%
 ...
 \texttt{\{haoqik, author2, author3\}@uw.edu} \\ % write your email
}
...
** SelfExplain is a neural text classifier that can self explains the text prediction using phrase-base concepts.
